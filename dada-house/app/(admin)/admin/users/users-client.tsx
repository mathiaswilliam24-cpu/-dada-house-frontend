...
import {
  ...
  Users, HardHat, Radio, Search, Eye, EyeOff,
  Crown, ClipboardList, Headset,
} from "lucide-react";

type Role = "ADMIN" | "CLIENT" | "TECHNICIAN" | "DISPATCHER" | "SUPER_ADMIN" | "MANAGER" | "CUSTOMER_SERVICE_REP";
type User = {
  id: string; name: string | null; email: string; phone: string | null;
  role: Role; createdAt: string; _count: { appointments: number };
};

const ROLES: Role[] = ["SUPER_ADMIN", "ADMIN", "MANAGER", "CUSTOMER_SERVICE_REP", "DISPATCHER", "TECHNICIAN", "CLIENT"];

const roleColor: Record<Role, string> = {
  SUPER_ADMIN:          "text-red-700 bg-red-50 border-red-200",
  ADMIN:                "text-red-700 bg-red-50 border-red-200",
  MANAGER:              "text-orange-700 bg-orange-50 border-orange-200",
  CUSTOMER_SERVICE_REP: "text-teal-700 bg-teal-50 border-teal-200",
...
const roleIcon: Record<Role, React.ReactNode> = {
  ...
  CUSTOMER_SERVICE_REP: <Headset className="w-3.5 h-3.5" />,
