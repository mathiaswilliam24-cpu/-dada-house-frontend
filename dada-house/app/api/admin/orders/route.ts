    ...
    if (status === "PROCESSING") {
      ...
      bodyHtml = `<p style="font-size:15px;color:#1e293b">Hi ${clientName || "there"},</p>
        ...
        <div style="background:#fefce8;border:1px solid #fde047;border-radius:8px;padding:14px;margin:16px 0">
          <p style="margin:0;color:#854d0e;font-size:14px">⏱ Please be ready to receive the technician. Need help? <a href="tel:+18449280875" style="color:#F97316">+1 (844) 928-0875</a></p>
        </div>`;
      ...
      bodyHtml = `<p style="font-size:15px;color:#1e293b">Hi ${clientName || "there"},</p>
        ...
        <p style="font-size:14px;color:#475569">Questions during the installation? Call us: <a href="tel:+18449280875" style="color:#F97316">+1 (844) 928-0875</a>.</p>`;
      ...
      bodyHtml = `<p style="font-size:15px;color:#1e293b">Hi ${clientName || "there"},</p>
        ...
        <div style="background:#f0fdf4;border:1px solid #bbf7d0;border-radius:8px;padding:14px;margin:16px 0">
          <p style="margin:0;color:#166534;font-size:14px">⭐ We hope you love your new installation! Any issues within the warranty period? <a href="tel:+18449280875" style="color:#166534">+1 (844) 928-0875</a></p>
        </div>`;
    } else if (status === "CANCELLED") {
      subject = `Order Cancelled — ${updated.orderNumber}`;
      bodyHtml = `<p style="font-size:15px;color:#1e293b">Hi ${clientName || "there"},</p>
        <p>Your order <strong>${updated.orderNumber}</strong> has been cancelled. If you believe this is an error or would like to reschedule, please contact us at <a href="tel:+18449280875" style="color:#F97316">+1 (844) 928-0875</a>.</p>`;
    }
      ...
      resend.emails.send({
        ...
        html: `<div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto">
          ...
          <div style="padding:28px">
            ${bodyHtml}
            <p style="margin-top:32px;font-size:12px;color:#94a3b8;text-align:center">DADA HOUSE · TX · NC · MD · <a href="tel:+18449280875" style="color:#F97316">+1 (844) 928-0875</a></p>
          </div>
        </div>`,
