      ...
      resend.emails.send({
        ...
        html: `<div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto">
          ...
          <div style="padding:28px">
            ...
            <p style="margin-top:24px;font-size:12px;color:#94a3b8;text-align:center">Questions? <a href="tel:+18449280875" style="color:#F97316">+1 (844) 928-0875</a> · DADA HOUSE · TX · NC · MD</p>
          </div>
        </div>`,
