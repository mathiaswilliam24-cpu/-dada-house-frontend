      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="space-y-5">
          ...
          <div className="border-t border-gray-100 pt-4">
            ...
            <a href="tel:+18449280875" className="inline-flex items-center gap-2 text-sm text-[#1B3FA8] font-semibold hover:underline">
              <Phone className="w-4 h-4" />Call us: +1 (844) 928-0875
            </a>
          </div>
        </div>
      </div>
