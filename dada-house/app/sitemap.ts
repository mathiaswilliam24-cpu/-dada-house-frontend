...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${base}/services/plumbing/jacksonville-nc`,         lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    { url: `${base}/services/air-conditioning/jacksonville-nc`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    { url: `${base}/services/heating/jacksonville-nc`,          lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    { url: `${base}/services/remodeling/jacksonville-nc`,       lastModified: now, changeFrequency: "monthly", priority: 0.8 },
