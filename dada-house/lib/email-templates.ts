          ...
          <tr>
            <td style="padding:40px;">
              ...
              <div style="background:#FFF7ED;border:1px solid #FED7AA;border-radius:12px;padding:20px;margin-top:24px;">
                ...
                <p style="margin:4px 0 0;color:#9A3412;font-size:13px;">Emergency: <strong>832-629-4398</strong></p>
              </div>
            </td>
          </tr>
      ...
      <table width="600" cellpadding="0" cellspacing="0" style="background:#fff;border-radius:16px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.08);">
        ...
        <tr>
          <td style="padding:40px;">
            ...
            <p style="margin:24px 0 0;color:#64748B;font-size:13px;">Questions? Call us at <strong>+1 (910) 685-8042</strong> or <strong>832-629-4398</strong> (Emergency).</p>
          </td>
        </tr>
        <tr>
