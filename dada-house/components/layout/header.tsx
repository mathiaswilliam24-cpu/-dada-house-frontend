...
export default function Header() {
  ...
  return (
    <header className="bg-[#1B3FA8] shadow-xl">
        ...
        <div className="flex items-center justify-between h-14 border-b border-white/10">
          ...
          <div className="flex items-center gap-2 flex-shrink-0">
            ...
            <a
              ...
              className="hidden sm:flex items-center gap-1 text-xs text-red-400 hover:text-red-300 font-semibold"
            >
              <Phone size={11} />
              Emergency
            </a>
            ...
            {session ? (
              <div className="relative">
                <button
                  ...
                  className="flex items-center gap-1.5 px-2.5 py-1.5 rounded-xl border border-white/30 hover:border-[#F7921A] transition-colors text-sm text-white font-medium"
                >
              ...
              <Link href="/auth/login"
                className="flex items-center gap-1.5 px-2.5 py-1.5 rounded-xl border border-white/40 text-xs font-bold text-white hover:bg-white/10 transition-colors">
                <User size={13} />
            ...
            <button
              className="sm:hidden p-1.5 rounded-lg text-white hover:bg-white/10 transition-colors"
